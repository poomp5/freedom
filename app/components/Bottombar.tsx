            ...
            <div className="relative grid h-full grid-cols-5 mx-auto">
                <Link href="/" className="w-full">
                    <button type="button"
                        ...
                        <svg className="w-6 h-6 mb-1 text-gray-500 group-hover:text-blue-600"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z" />
                        </svg>
                        <span className="text-xs text-gray-500 group-hover:text-blue-600">หน้าหลัก</span>
                    </button>
                </Link>
                <Link href="https://www.instagram.com/act.freedom" className="w-full">
                    <button type="button"
                        ...
                        <span className="text-xs text-gray-500 group-hover:text-blue-600">ติดต่อ</span>
                    </button>
                </Link>
                ...
                <Link href="/freedom" className="w-full">
                    <button type="button"
                        ...
                        <span className="text-xs text-gray-500 group-hover:text-blue-600">ยันต์</span>
                    </button>
                </Link>
                <Link href="donate" className="w-full">
                    <button type="button"
                        ...
                        <span className="text-xs text-gray-500 group-hover:text-blue-600">โดเนท</span>
                    </button>
                </Link>
            </div>
        </div>
