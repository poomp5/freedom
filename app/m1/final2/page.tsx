                        ...
                        <div className="w-full overflow-x-auto">
                            <table className="w-full whitespace-no-wrap">
                                ...
                                <tbody className="bg-white divide-y0">
                                    ...
                                    <tr className="text-gray-700">
                                        <td className="px-4 py-3">
                                            <Link href={'/m1/final2/eng.pdf'} className="flex items-center text-sm">
                                                <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                                                    <Image
                                                        className="icon-subject object-cover w-full h-auto"
                                    ...
                                    <tr className="text-gray-700">
                                        <td className="px-4 py-3">
                                            <Link href={'/m1/final2/history.pdf'} className="flex items-center text-sm">
                                                <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                                                    <Image
                                                        className="icon-subject object-cover w-full h-auto"
                                        ...
                                        <td className="px-4 py-3 text-xs">
                                            <Link href={'/m1/final2/history.pdf'}>
                                                <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">
                                                    ดาวน์โหลด
                                                </span>
                                            </Link>
                                    ...
                                    <tr className="text-gray-700">
                                        <td className="px-4 py-3">
                                            <Link href={'/m1/final2/social.pdf'} className="flex items-center text-sm">
                                                <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                                                    <Image
                                                        className="icon-subject object-cover w-full h-auto"
                                        ...
                                        <td className="px-4 py-3 text-xs">
                                            <Link href={'/m1/final2/social.pdf'}>
                                                <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">
                                                    ดาวน์โหลด
                                                </span>
                                            </Link>
                                    ...
                                    <tr className="text-gray-700">
                                        <td className="px-4 py-3">
                                            <Link href={'/m1/final2/thai.pdf'} className="flex items-center text-sm">
                                                <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                                                    <Image
                                                        className="icon-subject object-cover w-full h-auto"
