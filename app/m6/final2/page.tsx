        ...
        <div>
            ...
            <main className="mt-8 h-full overflow-y-auto">
                <div className="container px-4 lg:px-8 mx-auto grid md:mb-[4vh] mb-[12vh]">
                    ...
                    <p className="mx-auto mb-4 text-xl text-gray-500">ชีทสรุป (ม.6) ที่จัดทำในปีการศึกษา 2568</p>
                    <div className="w-full overflow-hidden rounded-lg shadow-xs">
                                ...
                                <tbody className="bg-white divide-y0">
                                    {/* <tr className="text-gray-700">
                                        <td className="px-4 py-3">
                                            <Link href={'/m6/final2/eng.pdf'} className="flex items-center text-sm">
                        ...
                        <PaginationFooter
                            ...
                            links={[
                                { label: "กลางภาค", href: "/m6/midterm2", isActive: false },
                                { label: "ปลายภาค", href: "/m6/final2", isActive: true },
                            ]}
                        />
                    </div>
                </div>
