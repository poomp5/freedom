export type SheetUploaderSocials = {
...
export function getSocialLinks(u: SheetUploaderSocials) {
  return SOCIALS_CONFIG.filter((s) => u[s.key]).map((s) => ({
...
export function getContactHref(u: SheetUploaderSocials, mainContact: string | null) {
  if (!mainContact) return null;
  const contactHrefs: Record<string, string | null> = {
    ig: u.socialIg ? `https://instagram.com/${u.socialIg}` : null,
    facebook: u.socialFacebook ? (u.socialFacebook.startsWith("http") ? u.socialFacebook : `https://facebook.com/${u.socialFacebook}`) : null,
    line: u.socialLine ? `https://line.me/ti/p/~${u.socialLine}` : null,
    discord: u.socialDiscord ? (u.socialDiscord.startsWith("http") ? u.socialDiscord : `https://discord.com/users/${u.socialDiscord}`) : null,
    x: u.socialX ? `https://x.com/${u.socialX}` : null,
  };
  return contactHrefs[mainContact] ?? null;
}
