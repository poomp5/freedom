  ...
  return (
    ...
    <section>
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1 className="mb-4 text-5xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-gray-600">สอบปลายภาค</h1>
            {/* <Countdown /> */}
            ...
            <div className="w-full overflow-x-auto">
              <table className="w-full whitespace-no-wrap">
                ...
                <tbody className="bg-white divide-y0">
                  ...
                  <tr className="text-gray-700">
                    <td className="px-4 py-3">
                      <Link href={'/m3/final2/thai_new.pdf'} className="flex items-center text-sm">
                        <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                          <Image
                            className="icon-subject object-cover w-full h-auto"
                        ...
                        <div className="inline-block">
                          <p className="font-semibold whitespace-nowrap">
                            ภาษาไทย (เนื้อหาวิจัย)
                          </p>
                          <p className="text-xs text-gray-600">
                            สอบปลายภาค (by <Link className="text-purple-800" href="https://discord.gg/Gjcr8XvaFM">ขบวนการมะ</Link>)
                          </p>
                        </div>
                      </Link>
                    </td>
                    ...
                    <td className="px-4 py-3 text-xs">
                      <Link href={'/m3/final2/thai_new.pdf'}>
                        <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">
                          ดาวน์โหลด
                        </span>
                      </Link>
                  ...
                  <tr className="text-gray-700">
                    <td className="px-4 py-3">
                      <Link href={'/m3/final2/history_new.pdf'} className="flex items-center text-sm">
                        <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                          <Image
                            className="icon-subject object-cover w-full h-auto"
                    ...
                    <td className="px-4 py-3 text-xs">
                      <Link href={'/m3/final2/history_new.pdf'}>
                        <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">
                          ดาวน์โหลด
                        </span>
                      </Link>
                  ...
                  <tr className="text-gray-700">
                    <td className="px-4 py-3">
                      <Link href={'/m3/final2/eng_new.pdf'} className="flex items-center text-sm">
                        <div className="inline-block relative w-8 h-8 mr-3 rounded-full">
                          <Image
                            className="icon-subject object-cover w-full h-auto"
                    ...
                    <td className="px-4 py-3 text-xs">
                      <Link href={'/m3/final2/eng_new.pdf'}>
                        <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">
                          ดาวน์โหลด
                        </span>
                      </Link>
